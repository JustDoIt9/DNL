      ...
      <div class="row">
		<div class="wrapper single">
			...
			<div class="btn-group" role="group">
			  ...
			  <router-link to="/switch/rate_table/new" type="button" class="custom_new btn btn-default">
			  ...
			  -->
			  <router-link to="" type="button" class="btn btn-default" @click.native="deleteAll">
				  <span class="dnl_icon dnl_action_delete"></span> Delete All
			  </router-link>
			  <router-link to="" type="button" class="btn btn-default" @click.native="deleteSelected">
